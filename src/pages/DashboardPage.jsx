    ...
    return (
        ...
        >
            ...
            <section className='mx-10 overflow-hidden min-h-[70vh] grid grid-cols-3 gap-[1px]  bg-border'>
                ...
                <div className="bg-background h-52 col-span-3 pr-10 pt-10">
                    <div className="flex flex-wrap items-center justify-around">
                        <div className='h-full p-3 flex flex-col gap-5 shadow-lg  '>
                            <button className="px-3 h-[20%] cursor-default py-1 bg-accent border-2 text-primary text-md font-semibold border-border shadow-md rounded-lg flex justify-center items-center ">{`פניות פתוחות- ${searchParams.get('room')}`}</button>
                            <span className=" text-6xl font-bold text-text text-center h-[80%] flex items-center justify-center">{countRoomReports?.roomResponseOpen?.length}</span>
                        </div>
                        <div className={`h-full p-3 flex flex-col gap-5 shadow-lg `}>
                            <button className="px-3 cursor-default py-1 bg-accent border-2 text-primary text-md font-semibold border-border shadow-md rounded-lg flex justify-center items-center ">  {dateToggle ? `פניות סגורות-${searchParams.get('room')}` : "פניות שנפתחו היום"}   </button>
                            <div className=" text-6xl font-bold text-text text-center h-full flex items-center justify-center">{dateToggle ? countRoomReports?.roomResponseClose?.length : countRoomReports?.openTodayReports?.length}</div>
                        </div>
                        <div className=' h-full p-3 flex flex-col gap-5 shadow-lg '>
                            <button className="px-3  cursor-default py-1 bg-accent border-2 text-primary text-md font-semibold border-border shadow-md rounded-lg flex justify-center items-center ">פניות פתוחות- רמ”מ</button>
                        ...
                        {dateToggle &&
                            <div className='h-full p-3 flex flex-col gap-5 shadow-lg '>
                                <button className="px-3  cursor-default py-1 bg-accent border-2 text-primary text-md font-semibold border-border shadow-md rounded-lg flex justify-center items-center ">פניות סגורות-רמ"מ</button>
                ...
                {/* <div className='col-span-3  bg-accent h-20'></div> */}
            </section>
        </TemplatePage>
    )
}
...
//                             <button className="px-3 cursor-default py-1 bg-accent border-2 text-primary text-md font-semibold border-border shadow-md rounded-lg flex justify-center items-center ">{`פניות פתוחות- ${searchParams.get('room')}`}</button>
